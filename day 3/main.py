    ...
    for j in match:
            ...
            if f_index == 0 and index == 0:
                if (re.search(symbol,i[l_index+1])):
                    ...
                    substring = lists[index+1][f_index:digit_len+1]
                    if re.search(symbol,substring):
                        sum += num
            ...
            # Top right corner
                ...
                if re.search(symbol,i[f_index-1]):
                    ...
                    substring = lists[index+1][f_index-1:len(i)]
                    if re.search(symbol,substring):
                        sum += num 
            ...
            # Bottom left corner
                ...
                if re.search(symbol,i[l_index+1]):
                    ...
                    substring = lists[index-1][f_index:l_index+2]
                    if re.search(symbol,substring):
                        sum += num 
            ...
            # Top middle
                ...
                if re.search(symbol,i[f_index-1]) or re.search(symbol,i[l_index+1]):
                    ...
                    substring = lists[index+1][f_index-1:l_index+2]
                    if re.search(symbol,substring):
                        sum += num
